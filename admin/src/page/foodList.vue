    ...
    methods: {
        ...
        async getFoods() {
            ...
            Foods.forEach((item, index) => {
                ...
                tableDataItem.item_id = item.item_id;
                tableDataItem.description = item.description;
                tableDataItem.rating = item.rating;
                tableDataItem.month_sales = item.month_sales;
                tableDataItem.restaurant_id = item.restaurant_id;
                tableDataItem.category_id = item.category_id;
                tableDataItem.image_path = item.image_path;
                tableDataItem.specfoods = item.specfoods;
